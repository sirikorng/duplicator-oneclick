...
<div class="wrap">
	...
	<h2 class="nav-tab-wrapper">
		...
		<a href="?page=duplicator-settings&tab=oneclick" class="nav-tab <?php echo ($current_tab == 'oneclick') ? 'nav-tab-active' : '' ?>"> <?php _e('OneClick', 'duplicator'); ?></a>
    ...
    switch ($current_tab) {
		...
		case 'package': include('packages.php');
            break;
		case 'oneclick': include('oneclick.php');
            break;
